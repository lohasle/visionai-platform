...
type Config struct {
	...
	EnableProductionLocalDocker bool
...
func Load() Config {
	return Config{
		Environment:                 env("NIMBUS_ENVIRONMENT", "DEVELOPMENT"),
		...
		EnableProductionLocalDocker: boolean("NIMBUS_ENABLE_PRODUCTION_LOCAL_DOCKER", false),
