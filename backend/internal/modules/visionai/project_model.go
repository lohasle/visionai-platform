...
type Project struct {
	...
	AIDomain        string        `gorm:"size:32;index;not null;default:CV" json:"aiDomain"`
	TaskType        string        `gorm:"size:64;index;not null;default:CV_DETECTION" json:"taskType"`
	DefaultProvider string        `gorm:"size:32;not null;default:LOCAL_DOCKER" json:"defaultProvider"`
	StorageBucket   string        `gorm:"size:128;not null;default:visionai-assets" json:"storageBucket"`
